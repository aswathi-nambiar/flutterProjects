...
List<Chat> chatBotsChat =[
  Chat(message: 'Hi', doctor: 'Angela', dateTime: 'Yesterday', image: 'https://images.pexels.com/photos/4173251/pexels-photo-4173251.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2', hasStory: true, isOnline: true, messageType: 'sender'),
  Chat(message: 'How can I help you?', doctor: 'Angela', dateTime: 'Yesterday', image: 'https://images.pexels.com/photos/4173251/pexels-photo-4173251.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2', hasStory: true, isOnline: true, messageType: 'sender'),
];
